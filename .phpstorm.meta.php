...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.E:\laragon\www\laravel-blog\public\storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links.E:\\laragon\\www\\laravel-blog\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'users.update','users.destroy','login','signup','logout',
'storage.local',);
        registerArgumentsSet('views', 
'layouts._footer','layouts._header','layouts.default','session.create','shared._errors',
'shared._messages','shared._user_info','static_pages.about','static_pages.help','static_pages.home',
'users.create','users.show','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
